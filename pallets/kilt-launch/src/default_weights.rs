...
//! DATE: 2021-10-08, STEPS: {{cmd.steps}}\, REPEAT: {{cmd.repeat}}\, LOW RANGE: {{cmd.lowest_range_values}}\, HIGH RANGE: {{cmd.highest_range_values}}\
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(25_267_000_u64)
			...
			.saturating_add((29_116_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(45_608_000_u64)
			...
			.saturating_add((98_848_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(69_296_000_u64)
			...
			.saturating_add((100_025_000_u64).saturating_mul(n as Weight))
